...
export interface RenovationProject{id:string;projectName:string;roomName:string;room:RoomDimensions;openings:Opening[];materials:MaterialType[];settings:Settings;results:MaterialResult[];createdAt:string;updatedAt:string}
